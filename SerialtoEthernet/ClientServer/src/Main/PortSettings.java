...
public class PortSettings {
	...
	public boolean Save() {
		...
		try {
			List<String> lines = Arrays.asList(PortName, String.valueOf(Baud), String.valueOf(Parity),
					String.valueOf(DataBits), String.valueOf(StopBits), String.valueOf(FlowControl));
